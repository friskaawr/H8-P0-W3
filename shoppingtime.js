...
function shoppingTime(memberId, money) {
    ...
    if (memberId === undefined || memberId === ''){
        ...
        history.money = money;
        history.listPurchased = arr_purchase;
        ...
        if (history.money < 50000){
            ...
            // console.log(history);
            if(money >= 1500000){
                arr_purchase.push('Sepatu Stacattu');
                money = money - 1500000;
            }
            if(money >= 500000){
                arr_purchase.push('Baju Zoro');
                money = money - 500000;
            }
            if(money >= 250000){
                arr_purchase.push('Baju brand H&N');
                money = money - 250000;
            }
            if(money >= 175000){
                arr_purchase.push('Sweater Brand Uniklooh');
                money = money - 175000;
            }
            if(money >= 50000){
                arr_purchase.push('Casing Handphone');
                money = money - 50000;
            }
